    ...
    public void updateUI() {
        ...
        if (SETTINGS) {
            ...
            if (mouseClick.getMouseX() >= (bX - 10) && mouseClick.getMouseX() <= 834 && mouseClick.getMouseY() <= 500 && mouseClick.getMouseY() >= 468) {
                mouseDirection = "BACK";if (changeSoundC < 2) changeSoundC++;
                side = true;
                xL = bX - 30;
                yL = 468;
                xR = 834;
        ...
        if (CREDITS) {
            ...
            if (mouseClick.getMouseX() >= (bX - 10) && mouseClick.getMouseX() <= 834 && mouseClick.getMouseY() <= 500 && mouseClick.getMouseY() >= 468) {
                ...
                xR = 834;
                yR = 468;
            } else {mouseDirection = "NONE";changeSoundC=0;}
        }
